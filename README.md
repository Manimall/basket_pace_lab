...
**V6 frozen** — текущий набор из 46 фичей (rolling stats / Pace / ORtg / DRtg)
не бьёт Pinnacle Closing Line на NBA на дистанции. Подтверждено bootstrap CI95
(5000 итераций) и контрольной группой из 14 лиг.
...
Дальнейшая работа — переход в неэффективные рынки (ABA-лига) и в новые
источники данных (травмы за 30 минут до тип-офа, назначения судей,
